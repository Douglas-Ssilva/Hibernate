...
//	Usamos quando queremos salvar alguma informação que nao seja na entidade main e que nao valha a pena criar uma entidade.
...
//        cliente.setEnderecos(Collections.singletonMap("casa", "Rua São Paulo, 5000, Brasil - Belo Horizonte/MG"));
